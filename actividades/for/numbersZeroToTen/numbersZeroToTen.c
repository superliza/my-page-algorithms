/*
	...
	Date: 30/11/19 19:58
	Description: Mostrar en pantalla los n˙meros del 0 al 100 con un incremento de 0.5.
...
//Inicia el programa con la funciÛn main.
int main() {
	
	//InicializaciÛn de varibale contadora de tipo float.
	float fCount = 0;
